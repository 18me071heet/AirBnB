package javaLearning;
	...
	int x=100;       // By default interface treated variable as static final int x=100;
	void scan();
   ...
   public class InterfaceDemo3 {
   	...
   	public static void main(String[] args) {
   	  ...
   	  //	Print.x=10;    --> Can't change the value coz in interface variable is treated as final .
